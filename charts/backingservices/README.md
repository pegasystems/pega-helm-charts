...
Certificates used by external elasticsearch needs to be placed on to an accessible location for make command to use.
eg: If certs are placed under /home/certs. Make command will look like this:
make external-es-secrets NAMESPACE=pegabackingservices PATH_TO_CERTIFICATE=/home/certs/truststore.jks

| Configuration                            | Usage                                                                                                                                                                                                                                                                                                                               |
|------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `tls`                                    | Setting this to true will make SRS service to use es certificates for connection.                                                                                                                                                                                                                                                   |
| `externalESDeployment.username`          | Give the value of the username as shown in connection info section of externalESDeployment.                                                                                                                                                                                                                                         |
| `externalESDeployment.username`          | Give the value of the password as shown in connection info section of externalESDeployment.                                                                                                                                                                                                                                         |
| `srsStorage.provisionInternalESCluster`  | <ul><li>Set to `false` to disable this parameter to use your own Elasticsearch service from the SRS cluster; this Requires you to run `$ make external-es-secrets NAMESPACE=<NAMESPACE_USED_FOR_DEPLOYMENT> PATH_TO_CERTIFICATE=<PATH_TO_CERTS>`. </li><li> PATH_TO_CERTIFICATE takes the location value of the placed </li></ul>   |
| `domain`                                 | DNS entry associated with externalESDeployment.                                                                                                                                                                                                                                                                                     |
