...
To enable a secure connection between SRS and Elasticsearch below steps are to be followed.
...
|------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `tls`                                    | Setting this to true will make the SRS service use es certificates for connection.                                                                                                                                                                                                                                                |
| `externalESDeployment.username`          | Give the value of the username as shown in the connection info section of externalESDeployment.                                                                                                                                                                                                                                   |
| `externalESDeployment.username`          | Give the value of the password as shown in the connection info section of externalESDeployment.                                                                                                                                                                                                                                   |
