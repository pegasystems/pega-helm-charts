...
srs:
  ...
  srsStorage:
    ...
    # To configure either authentication method, when the elasticsearch domain requires an open internet connection,set requireInternetAccess parameter to "true".
