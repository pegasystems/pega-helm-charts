...
\>= 8.6                 | \>=1.12.0     | 7.10.2                    | Pega Infinity 8.6 and later supports using a Pega-provided platform-services/search-n-reporting-service Docker Image that is tagged with version 1.12.0 or later (Pega recommends using 1.17.10-20211230110404597 or later). All SRS Docker image versions are certified to support Elasticsearch version 7.10.2.
