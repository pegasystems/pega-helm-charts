...
| `urlPath`                               | Base path exposed by ingress for messaging requests.                                                                                                                                                                                                                                                                                          |
| `pingPath`                               | Health-check endpoint path used by liveness/readiness probes and GKE backend checks. Default is `/k8s/ping`.                                                                                                                                                                                                                                                                                          |
