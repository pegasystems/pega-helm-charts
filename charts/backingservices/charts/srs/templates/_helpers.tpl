...
*/}}
{{- define "srs.dns" -}}
{{ if not (hasKey .Values "isOpenShiftDeployment") }}
{{- "'.Values.isOpenShiftDeployment' entry is required for configuring the network policy for srs."  | fail }}
{{ else if .Values.isOpenShiftDeployment }}
- ports:
    - protocol: UDP
      port: 5353
  to:
