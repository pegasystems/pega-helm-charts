...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Enabled</td>
            <td>Elasticsearch 7.17.9, 7.17.29, 8.10.3, 8.15.1, 8.15.5, 8.18.2, 8.18.3, 8.18.6 & 8.19.18</td>
...
To migrate to Elasticsearch version 7.17.9, 7.17.29, 8.10.3, 8.15.1, 8.15.5, 8.18.2, 8.18.3, 8.18.6 or 8.19.18 from the Elasticsearch version 7.10.2 or 7.16.3, perform the following steps:
...
3. To update Elasticsearch version to 8.10.3, 8.15.1, 8.15.5, 8.18.2, 8.18.3, 8.18.6 or 8.19.18, perform the following actions:
   * Update the Elasticsearch `dependencies.version` parameter in the [requirement.yaml](../../requirements.yaml) to 8.5.1.

     Note: This parameter references the Elasticsearch Helm chart version and not the Elasticsearch cluster version.
   * Update the elasticsearch.imageTag in the Backing Services Helm chart to 8.10.3, 8.15.1, 8.15.5, 8.18.2, 8.18.3, 8.18.6 or 8.19.18.
...
3. To use Elasticsearch version 8.10.3, 8.15.1, 8.15.5, 8.18.2, 8.18.3, 8.18.6 or 8.19.18, upgrade your external Elasticsearch cluster to 8.10.3, 8.15.1, 8.15.5, 8.18.2, 8.18.3, 8.18.6 or 8.19.18 according to your organization’s best practices. For more information, see official Elasticsearch version 8.x documentation.
4. Restart the SRS pods.
