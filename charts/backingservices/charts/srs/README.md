...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Enabled</td>
            <td>Elasticsearch 7.10.2, 7.16.3, 7.17.9, 8.10.3, 8.15.1 & 8.18.2</td>
        ...
        <tr>
            <td>Enabled</td>
            <td>Elasticsearch 7.17.9, 8.10.3, 8.15.1 & 8.18.2</td>
            <td>As a best practice, use Elasticsearch version 8.18.2.</td>
        </tr>
        <tr>
...
To migrate to Elasticsearch version 7.17.9, 8.10.3, 8.15.1 or 8.18.2 from the Elasticsearch version 7.10.2 or 7.16.3, perform the following steps:
...
3. To update Elasticsearch version to 8.10.3, 8.15.1 or 8.18.2, perform the following actions:
    * Update the Elasticsearch `dependencies.version` parameter in the [requirement.yaml](../../requirements.yaml) to 8.5.1.

      Note: This parameter references the Elasticsearch Helm chart version and not the Elasticsearch cluster version.
    * Update the elasticsearch.imageTag in the Backing Services Helm chart to 8.10.3, 8.15.1 or 8.18.2.
...
3. To use Elasticsearch version 8.10.3, 8.15.1 or 8.18.2, upgrade your external Elasticsearch cluster to 8.10.3 8.15.1 or 8.18.2 according to your organization’s best practices. For more information, see official Elasticsearch version 8.x documentation.
4. Restart the SRS pods
