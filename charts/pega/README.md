...
`hpa.targetAverageCPUValue` | Threshold value for scaling based on absolute CPU usage | `2.8`
...
`hpa.enableMemoryTarget` | Set to true if you want to enable scaling based on memory utilization or false if you want to disable it (It is recommended to leave this disabled) | false
