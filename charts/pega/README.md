...
`out-of-place-rules` | Use this option to migrate a copy of the rules to a new schema and run an out-of-place upgrade in that copied schema. This schema will become the rules schema after your upgrade is complete.
