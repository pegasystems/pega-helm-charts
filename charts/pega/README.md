...
# Stream (externalized Kafka service) settings.
stream:
  # Enabled by default. When enabled deployment will use external Kafka as per configuration and doesn't use the "Stream" node type. Disable this setting to use the "Stream" node type.
  enabled: true
