...
`out-of-place-rules` | Use this option to run an out-of-place upgrade of rules that runs against a migrated copy of the rules schema. This schema will become the rules schema after your upgrade is complete.
