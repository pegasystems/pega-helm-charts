...
stream:
  ...
  # Please add the Kubernetes secret name, that holds the trustStore certificate, in 'global.certificatesSecrets'.
  ...
  # Please add the Kubernetes secret name, that holds the keyStore certificate, in 'global.certificatesSecrets'.
