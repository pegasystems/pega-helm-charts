...
`annotations` | Optionally add custom annotations for advanced configuration. Specifying a custom set of annotations will result in them being used *instead of* the default configurations in case of EKS, k8s, otherwise they will be appended to the default list in case of GKE, AKS.
