...
11. To download your preferred version of the `search-n-reporting-service` image to your local system, specify the `<srs-version>` tag (refer [compatibility matrix](../charts/backingservices/README.md#srs-version-compatibility-matrix)) when you enter:
