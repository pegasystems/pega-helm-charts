...
| srs.srsRuntime.srsImage: | Specify the Pega-provided srs-service image, services/search-n-reporting-service:dockerTag that you downloaded and pushed to your Docker registry. | srs.srsRuntime.srsImage: "platform-services/search-n-reporting-service:<sr-version>". For `<srs-version>` tag (refer [compatibility matrix](../charts/backingservices/README.md#srs-version-compatibility-matrix))     |
