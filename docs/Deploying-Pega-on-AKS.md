...
The pega and addons charts in the /charts/pega folder require customization for your organization's AKS deployment of Pega Platform. The backingservices chart is optional, but recommended for Pega Infinity 8.6 and later.
