...
2. Use a text editor to open the pega.yaml file and update the following parameters in the chart based on your AKS requirements:
   ...
   | jdbc.podbinding: | Specify aadpodidbinding label name. | AzureIdentityBinding selector value. Specify "aadpodidbinding" to manage your Identity binding required to configure authentication with an Azure SQL database on AKS. |
