...
`constellation-messaging/docker-image`  | An image that deploys the constellation messaging service. For more information about this service, see [Instructions to configure the constellationui service](charts/backingservices/charts/constellation-messaging/README.md). | `<version>` |
