...
`platform-services/search-n-reporting-service`  | An image to deploy the required search engine for the latest generation of search and reporting capabilities in Pega Infinity as a backing service. This Docker image contains Pega Search and Reporting Service.| `<version>` |
